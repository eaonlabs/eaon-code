...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@eaonlabs/eaon-tui";
...
```typescript
import { Container, type Focusable, Input } from "@eaonlabs/eaon-tui";
...
Import from `@eaonlabs/eaon-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@eaonlabs/eaon-tui";
```
...
```typescript
import { matchesKey, Key } from "@eaonlabs/eaon-tui";
...
```typescript
import { MouseRegion } from "@eaonlabs/eaon-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@eaonlabs/eaon-tui";
...
```typescript
import { getMarkdownTheme } from "@eaonlabs/eaon-code";
import { Markdown } from "@eaonlabs/eaon-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@eaonlabs/eaon-tui` with `DynamicBorder` for framing.
...
For toggling multiple settings. Use `SettingsList` from `@eaonlabs/eaon-tui` with `getSettingsListTheme()`.
...
import { matchesKey, truncateToWidth } from "@eaonlabs/eaon-tui";
