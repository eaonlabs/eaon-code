> Eaon Code can create prompt templates. Ask it to build one for your workflow.
...
Eaon Code loads prompt templates from:

- Global: `~/.eaon/agent/prompts/*.md`
- Project: `.eaon/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `eaon.prompts` entries in `package.json`
