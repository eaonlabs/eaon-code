...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@eaonlabs/eaon-ai`, `@eaonlabs/eaon-agent-core`, `@eaonlabs/eaon-code`, `@eaonlabs/eaon-tui`, `typebox`.
