...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@eaonlabs/eaon-code";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@eaonlabs/eaon-tui";
