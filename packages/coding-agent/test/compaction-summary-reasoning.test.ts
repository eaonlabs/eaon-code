import type { AgentMessage } from "@eaonlabs/eaon-agent-core";
import { type AssistantMessage, type Model, normalizeContext, type TranscriptContext } from "@eaonlabs/eaon-ai";
...
vi.mock("@eaonlabs/eaon-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@eaonlabs/eaon-ai/compat")>();
	return {
		...actual,
