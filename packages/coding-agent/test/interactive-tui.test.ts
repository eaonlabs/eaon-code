import type { Component, Terminal, TUI } from "@eaonlabs/eaon-tui";
import { Container, getKeybindings, isViewportTUI, ScrollView, setKeybindings, Text } from "@eaonlabs/eaon-tui";
