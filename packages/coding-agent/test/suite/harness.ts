...
import type { FauxModelDefinition, FauxProviderRegistration, FauxResponseStep, Model } from "@eaonlabs/eaon-ai/compat";
import { registerFauxProvider, streamSimple } from "@eaonlabs/eaon-ai/compat";
