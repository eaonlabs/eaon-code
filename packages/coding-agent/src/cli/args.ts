...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self]         Update Eaon Code, extensions, or model catalogs
...
${chalk.bold("Environment Variables:")}
  ...
  EAON_CODE_PACKAGE_DIR            - Override package directory (legacy: PI_PACKAGE_DIR)
  EAON_CODE_OFFLINE                - Disable startup network operations (legacy: PI_OFFLINE)
  EAON_CODE_TELEMETRY              - Control provider attribution headers (legacy: PI_TELEMETRY)
  EAON_CODE_SHARE_VIEWER_URL       - Optional /share viewer base URL (legacy: PI_SHARE_VIEWER_URL)
