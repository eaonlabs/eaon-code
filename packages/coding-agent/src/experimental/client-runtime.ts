...
import { Client, ServerError } from "@eaonlabs/eaon-client";
import { createUnixTransportFactory, discoverUnixServers, type UnixServerRoute } from "@eaonlabs/eaon-client/unix";
