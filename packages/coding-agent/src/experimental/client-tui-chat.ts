import type { AgentMessage, Entry, LaneSnapshot } from "@eaonlabs/eaon-agent-core";
import type { AssistantMessage } from "@eaonlabs/eaon-ai";
import { Container, Spacer, Text, TruncatedText, type TUI } from "@eaonlabs/eaon-tui";
