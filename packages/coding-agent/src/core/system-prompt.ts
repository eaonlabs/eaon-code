...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
	...
	let prompt = `You are an expert coding assistant operating inside Eaon Code, a coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.
...
Eaon Code documentation (read only when the user asks about the agent itself, its SDK, extensions, themes, skills, or TUI):
