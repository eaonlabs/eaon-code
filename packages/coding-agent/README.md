...
Eaon Code is a minimal terminal coding harness, built atop the [Pi agent harness](https://github.com/earendil-works/pi). Adapt it to your workflows, not the other way around, without having to fork and modify internals. Extend it with TypeScript [Extensions](#extensions), [Skills](#skills), [Prompt Templates](#prompt-templates), and [Themes](#themes). Put your extensions, skills, prompt templates, and themes in [Packages](#pi-packages) and share them with others via npm or git.

Eaon Code ships with powerful defaults but skips features like sub agents and plan mode. Instead, you can ask the agent to build what you want or install a third-party package that matches your workflow.
