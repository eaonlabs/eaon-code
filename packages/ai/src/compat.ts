 ...
 *
 * Existing apps switch imports from "@eaonlabs/eaon-ai" to
 * "@eaonlabs/eaon-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@eaonlabs/eaon-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@eaonlabs/eaon-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@eaonlabs/eaon-ai/providers/all" or `Models.getProviders()`. */
