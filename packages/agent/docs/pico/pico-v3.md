...
```ts
import { AssistantMessageFrameEncoder, type AssistantMessageFrame } from "@eaonlabs/eaon-ai";
...
import { createContextKey, withAbortSignal, withContextValue } from "@eaonlabs/chord/context";
