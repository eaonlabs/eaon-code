...
`AssistantMessageFrame`, `AssistantMessageFrameEncoder`, and `reduceAssistantMessageFrames()` come from `@eaonlabs/eaon-ai`. Do not define a second frame codec or reducer.
