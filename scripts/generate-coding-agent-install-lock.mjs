...
const internalPackagePrefix = "@eaonlabs/eaon-";
const internalPackageNames = new Set(["@eaonlabs/chord"]);
const installPackageName = "@eaonlabs/eaon-code-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the Eaon Code installer and updater.",
		dependencies: {
