...
// Bump this only when generated model metadata requires behavior unavailable in older Eaon Code clients.
...
async function main() {
	...
	const temporaryDir = mkdtempSync(join(tmpdir(), "eaon-model-catalog-"));
	try {
