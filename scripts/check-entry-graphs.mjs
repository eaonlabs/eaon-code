...
const WORKSPACE = {
	"@eaonlabs/chord": "packages/chord/src",
	"@eaonlabs/eaon-ai": "packages/ai/src",
	"@eaonlabs/eaon-agent-core": "packages/agent/src",
	"@eaonlabs/eaon-telemetry": "packages/telemetry/src",
	"@eaonlabs/eaon-tui": "packages/tui/src",
};
